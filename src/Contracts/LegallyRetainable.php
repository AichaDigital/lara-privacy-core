 ...
 *
 * The domain (an accounting document, a medical record, a consent log…)
 * implements this and owns the obligation; lara-privacy only reads it to decide
 * whether the object may be touched. The privacy layer type-hints this
...
interface LegallyRetainable
{
     ...
     * (e.g. a draft that was never finalised).
     *
